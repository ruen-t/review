...
lo=$((RANDOM%12+1))
		    ...
		    eval "curl -X POST --header 'Content-Type: application/json' --header 'Accept: application/json' --header 'X-CSRFToken: Cgd8agpn80oUBL5JqgD2WArPguyCKi6eLq855IIT9SS3HrpPAOZxKSlp00nQkJeZ' -d '{ \"review_location\": \""$lo"\", \"review_date\": \""$t"\", \"development\": \""$d"\", \"review_type\": \""$rt"\", \"review_comment\": \"This is API test.\" }' 'http://172.16.252.110/reviewtoolapi/review/add/'"
